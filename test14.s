# Changes the name of the array to mainValues instead of mainNumbers
# printArray does not restore $a0, $a1, $a2 (does not have to)
# mainValues has zero elements

# Print starting with element 0
# Print starting with element 1
# Print starting with element 2
# Print starting with element 3

# Array contains 17 elements, which does require extra
...
main:
         ...
         la    $t1, mainValues  # $t1 = addr mainValues[0]

mainLoopBegin:
         add   $t2, $t1, $t0     # $t2 = addr mainValues[i]
         lh    $a0, 0($t2)       # $a0 = mainValues[i]
