...
# This test case is checking if the skip function preserves
#    $t registers, if necessary.
# printArray puts negative numbers in each of the $t registers
#    just before its epilogue.

# There are 49 numbers in mainNumbers, not counting the 0 at the end.
...
printArrayLoopEnd:
         ...
         # Done to see if skip: preserves this, if necessary
         addi $t0, $zero, -1111
         addi $t1, $zero, -1111
         addi $t2, $zero, -2222
         addi $t3, $zero, -3333
