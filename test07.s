...
# This test case tests if the programmer is using the newline
# string from main or printArray, or using their own.

# This is done by having mainNewline and printArrayNewline print
# their name each time a newline is printed in those two functions.

# There are 7 values in mainNumbers, not counting the 0 at the end.
